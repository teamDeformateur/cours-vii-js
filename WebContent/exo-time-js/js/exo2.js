var bid = {
  ...
  /*
   * Properties créées pendant l'éxécution :
   * counterDom
   * formDom
   * currentDom
   * amountDom
  ...
  /**
   * Submit
   * @param event : l'objet d'evenement, qui comporte des infos sur l'évenement qui vient d'être lancé
   */
  submit: function(event) {
    console.info('bid.submit');

    // On empêche le comportement par défault
    // Le comportement par défaut d'un form : faire une requete / recharger la page
